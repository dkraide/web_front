                    ...
                    >
                        <Tab color={'red'} eventKey="produto" title="Produto">
                            <div className={styles.content}>
                                ...
                                <InputForm placeholder={'Nome do Produto'} defaultValue={obj.nome} width={isMobile ? '100%' : '75%'} title={'Nome'} errors={errors} inputName={"nome"} register={register} />
