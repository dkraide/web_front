...
// import IProdutoGrupo from '@/interfaces/IGrupoAdicional';
...
// type ItemRowProps = {
//     item: IProdutoGrupoItem
//     grupo: IProdutoGrupo
//     setGrupo: React.Dispatch<React.SetStateAction<IProdutoGrupo | undefined>>
// }

// function ItemRow({ item, grupo, setGrupo }: ItemRowProps) {

//     const fileInputRef = useRef<HTMLInputElement>(null);

//     const handleChangeValue = (newValue: any, field: string) => {
//         const indexItem = _.findIndex(grupo.itens, p => p.id == item.id);
...
//             <SelectMateriaPrima
//                 width={'calc(35% - 150px)'}
//                 selected={item.materiaPrimaId}
//                 setSelected={handleMateriaPrimaChanged}
//             />
...
//                 title={'Nome'}
//                 value={item.nome}
//                 onChange={({ currentTarget }) => handleChangeValue(currentTarget.value, 'nome')}
//             />
...
//                 title={'Valor'}
//                 value={item.valor}
//                 onChange={({ currentTarget }) => handleChangeValue(currentTarget.value, 'valor')}
//             />
...
//                             setGrupo({ ...grupo, descricao: currentTarget.value })
//                         }
//                     />

//                     <Switch
//                         onColor={'#fc4f6b'}
//                         onChange={(e) => setGrupo({ ...grupo, status: e })}
...
//                         value={grupo.minimo}
//                         onChange={({ currentTarget }) =>
//                             setGrupo({ ...grupo, minimo: parseInt(currentTarget.value) })
//                         }
//                     />
...
//                         value={grupo.maximo}
//                         onChange={({ currentTarget }) =>
//                             setGrupo({ ...grupo, maximo: parseInt(currentTarget.value) })
//                         }
//                     />
...
//                     <CustomButton onClick={handleNewItem}>
//                         Novo Item
//                     </CustomButton>
